...

{
    ...
    "title": "Timing",
    "category": "section",
    "text": "For this moderate-sized data set, ordinalgwas takes less than 0.2 second.@btime(ordinalgwas(@formula(trait ~ sex), datadir * \"covariate.txt\", datadir * \"hapmap3\"));  145.716 ms (609601 allocations: 30.95 MiB)# clean up\nrm(\"ordinalgwas.null.txt\", force=true)\nrm(\"ordinalgwas.pval.txt\", force=true)"
},
