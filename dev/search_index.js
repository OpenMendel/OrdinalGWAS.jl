...

{
    ...
    "title": "Basic usage",
    "category": "section",
    "text": "The following command performs GWAS using the proportional odds model.polrgwas(@formula(trait ~ 0 + sex), \"../data/covariate.txt\", \"../data/hapmap3\")For documentation of the polrgwas function, type ?polrgwas in Julia REPL."
},

{
    ...
    "category": "section",
    "text": "The first argument specifies the null model without SNP effects, e.g., @formula(trait ~ 0 + sex), it\'s important to exclude the intercept because proportional odds model automatically incorporates intercepts for modeling purpose."
},
...

{
    ...
    "title": "Docker",
    "category": "section",
    "text": "For ease of using PolrGWAS, we provides a Dockerfile so users don\'t need to install Julia and required packages. Only Docker app needs to be installed. Following is tested on ???"
},
