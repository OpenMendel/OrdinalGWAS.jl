...

{
    ...
    "title": "Timing",
    "category": "section",
    "text": "For this moderate-sized data set, ordinalgwas takes less than 0.2 second.@btime(ordinalgwas(@formula(trait ~ sex), datadir * \"covariate.txt\", datadir * \"hapmap3\"));  162.015 ms (710982 allocations: 33.35 MiB)# clean up\nrm(\"ordinalgwas.null.txt\")\nrm(\"ordinalgwas.pval.txt\")"
},
