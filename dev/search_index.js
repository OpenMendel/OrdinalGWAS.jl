...

{
    ...
    "title": "Timing",
    "category": "section",
    "text": "For this moderate-sized data set, polrgwas takes less than 0.2 second.@btime(polrgwas(@formula(trait ~ 0 + sex), \"../data/covariate.txt\", \"../data/hapmap3\"))  130.269 ms (639486 allocations: 29.14 MiB)rm(\"polrgwas.scoretest.txt\")\nrm(\"polrgwas.nullmodel.txt\")"
},
