...

{
    ...
    "title": "Input files",
    "category": "section",
    "text": "ordinalgwas expects two input files: one for responses plus covariates (second argument), the other the Plink files for genotypes (third argument).Covariates and phenotype are available in a csv file, e.g., covariate.txt, which has one header line for variable names. Variable trait is the ordered categorical phenotypes coded as integers 1 to 4. We want to include variable sex as the covariate in GWAS.run(`head $(datadir)covariate.txt`);famid,perid,faid,moid,sex,trait\n2431,NA19916,0,0,1,4\n2424,NA19835,0,0,2,4\n2469,NA20282,0,0,2,4\n2368,NA19703,0,0,1,3\n2425,NA19901,0,0,2,3\n2427,NA19908,0,0,1,4\n2430,NA19914,0,0,2,4\n2470,NA20287,0,0,2,1\n2436,NA19713,0,0,2,3Genotype data is available as binary Plink files.readdir(glob\"hapmap3.*\", datadir)4-element Array{String,1}:\n \"/Users/huazhou/.julia/dev/OrdinalGWAS.jl/data/hapmap3.bed\"\n \"/Users/huazhou/.julia/dev/OrdinalGWAS.jl/data/hapmap3.bim\"\n \"/Users/huazhou/.julia/dev/OrdinalGWAS.jl/data/hapmap3.fam\"\n \"/Users/huazhou/.julia/dev/OrdinalGWAS.jl/data/hapmap3.map\"There are 324 samples at 13,928 SNPs.size(SnpArray(datadir * \"hapmap3.bed\"))(324, 13928)"
},
...

{
    ...
    "title": "Timing",
    "category": "section",
    "text": "For this moderate-sized data set, ordinalgwas takes less than 0.2 second.@btime(ordinalgwas(@formula(trait ~ sex), datadir * \"covariate.txt\", datadir * \"hapmap3\"));  163.797 ms (710982 allocations: 33.35 MiB)# clean up\nrm(\"ordinalgwas.null.txt\")\nrm(\"ordinalgwas.pval.txt\")"
},
