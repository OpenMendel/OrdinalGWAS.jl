...

{
    ...
    "title": "Timing",
    "category": "section",
    "text": "For this moderate-sized data set, polrgwas takes less than 0.2 second.@btime(polrgwas(@formula(trait ~ sex), \"../data/covariate.txt\", \"../data/hapmap3\"))  133.562 ms (639428 allocations: 29.13 MiB)# clean up\nrm(\"polrgwas.scoretest.txt\")\nrm(\"polrgwas.nullmodel.txt\")"
},
